...
namespace LeaveManagement.Web.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StartDate,EndDate,LeaveTypeId,LeaveRequested,RequsetComment,Approved,Canceled,RequstingEmployeeId,Id,DateCreate,DateModified")] LeaveRequest leaveRequest)
        {
